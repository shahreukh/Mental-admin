    ...
    <div class="modal-content">
        <form action="{{ url('admin/delete-category') }}" method="POST">
            ...
            <div class="modal-body">
                ...
                <h5>Do you want to delete this category with all its posts?</h5>
            </div>
                    ...
                    <tbody>
                        ...
                        <tr>
                            ...
                            <td>
                                ...
                                <button type="button" class="btn btn-danger deleteCategoryBtn" value="{{ $item->id }}" data-bs-toggle="modal" data-bs-target="#deleteModal">Delete</button>
                            </td>
                        </tr>
                        @endforeach
                    </tbody>
