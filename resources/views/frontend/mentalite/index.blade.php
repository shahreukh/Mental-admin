        ...
        <div class="carousel-inner" role="listbox">
            <div class="carousel-item active">
                <video  preload="auto" autoplay="" muted="" playsinline="" data-object-fit="cover" style="width: 100%!important">
                    <source src="{{ asset('assets/mental/images/carousel/videos/hakkimizdabanner.mp4') }}" type="video/mp4">
                </video>
            </div>
        </div>
    </div>
...
<div class="section about-section layout_padding padding_top_0">
    <div class="mental-container">
        <div class="row about-wrapper full margin-top_30">
            @foreach ($all_mentalites as $all_mentalite_item)
                <div class="col-lg-4 col-md-12 col-sm-12 about-welcome-text" style="margin-top: 35%!important;margin-bottom: 35%!important; padding-right:15px; padding-left:15px">
                    {!! $all_mentalite_item->introduction !!}
                </div>
              
                <div class="col-lg-8 col-md-12 col-sm-12 hakkimizda-text" style="padding-right:15px; padding-left:15px">
                    {!! $all_mentalite_item->description !!}
                </div>  
            @endforeach
        </div>
    </div>
